        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="lg:order-2 space-y-8">
            <img
              ...
              loading="lazy"
              className="w-full h-auto rounded-lg shadow-lg object-cover aspect-video border border-[var(--color-border)]"
            />
            <img
          ...
          <div className="lg:order-1">
            <h3 className="text-2xl font-semibold mb-6 text-[var(--color-text-primary)]">Quality Framework</h3>
              ...
              {QUALITY_FRAMEWORK.map((item, index) => (
                <li key={index} className="flex items-start">
                  ...
                  <p className="text-[var(--color-text-secondary)]">
                    <span className="font-semibold text-[var(--color-text-primary)]">{item.title}</span>{item.description}
                  </p>
                </li>
              ))}
            </ul>

            <h3 className="text-2xl font-semibold mb-4 text-[var(--color-text-primary)]">Process Philosophy</h3>
