...
const SkeletonProductCard: React.FC = () => {
  return (
    <div className="bg-[var(--color-surface-primary)] p-6 rounded-[var(--radius)] shadow-sm border border-[var(--color-border)] h-full flex flex-col">
      <div className="animate-pulse">
        {/* Skeleton for Category Name */}
        <div className="h-3 bg-[var(--color-border)] rounded-full w-1/3 mb-4"></div>
        
        {/* Skeleton for Product Name */}
        <div className="h-5 bg-[var(--color-text-secondary)] rounded-full w-3/4 mb-2"></div>
